...
# note these plots are only for illustrative purposes to show how get.tau.permute() can generate the null distribution. These should not be used for graphical hypothesis testing nor parameter estimation of the clustering endpoint.
